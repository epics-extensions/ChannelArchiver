...
public:
	...
	static DataFile *reference (const stdString &filename);
...
private:
	...
	DataFile (const stdString &filename);
...
public:
	...
	{	return _file && _file->addNewValue (*this, value, update_header);	}
	...
	void save ()
	{	_header.write (_file->_fd, _header_offset);	}

	const stdString &getFilename () const { return _file->getFilename ();	}
	const stdString &getBasename () const { return _file->getBasename ();	}
	...
	FILE *getFd () const
	{	LOG_ASSERT (_file);		return _file->_fd;	}
