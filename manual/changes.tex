...
That data used to be accessed by selecting from a long list of
subsystems. This list has been reduced to two, basically
selecting data from the currently running archive engines
and previous data.
