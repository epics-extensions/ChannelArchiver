...
% ======================================================================
Each computer needs to have the same copy of ``/arch/\INDEX{archiveconfig.xml}'',
...
They can be used in ``\INDEX{cron}'' jobs to periodically update
...
\INDEX{secure-copy (scp)} to pull new sub-archives onto this computer,
optionally with \INDEX{md5 checksum}.  Finally invokes update\_indices.pl.
